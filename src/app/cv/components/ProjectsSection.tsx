...
import { ProjectEntry } from "@/app/cv/lib/types";
        ...
        {bullets.map((b, bi) => {
          ...
          return (
            <div
              ...
              draggable
              onDragStart={ev => {
                ev.stopPropagation(); // prevent card from seeing this drag
...
export default function ProjectsSection({ data, onChange }: Props) {
  ...
  const upd  = (id: string, k: keyof ProjectEntry, v: string) =>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, flex: 1, padding: "11px 14px" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {(e.role || e.periodStart || e.periodEnd) && (
            ...
            {isOpen && (
              <div style={{ padding: "16px 14px", display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                  <div>
                    <label className="label">Project / Society / Activity</label>
                    <input className="input" value={e.title}
                      onChange={ev => upd(e.id, "title", ev.target.value)}
                      placeholder="Intergalactic Finance Club" />
                  </div>
                  <div>
                ...
                <div style={{ height: "1px", background: "none", borderTop: "1.5px dashed var(--border)", margin: "2px 0" }} />
